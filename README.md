...
*Área do PET
*
 uma página inicial com todos os recursos disponíveis, como produtos, área para marcação de banho, tosa e consulta; área do pet que terá os dados do animal como nome, peso, relatório de consultas dentre outros; área de blog, como notícias e dicas e uma área para adoção e outra para procura-se.
